...
# Note: In production, you would import these from the original file
# For now, we'll include the essential ones here
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        # Example: Create a configuration programmatically
        print("Enhanced Kubernetes Cluster Generator with Dynamic Configuration")
        print("="*80)
        print("\nExample: 10-node microservices cluster with hub-spoke topology\n")
        ...
        config = ClusterDynamicConfig(
            ...
            subnet_config=SubnetConfig(
                ...
                sensitive_subnet_probabilities={
                    3: 0.7,  # Data tier has high probability of sensitive hosts
            ...
            osint_config=OsintConfig(
                status="enabled",
                services_strategy="graph_theory_random",
