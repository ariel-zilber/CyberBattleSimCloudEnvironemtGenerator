"""
Logical Topology Visualizer
===========================
Generates visualizations of the abstract service graph (Logical Layer).
Displays connections colored by authentication status and firewall rules.
"""
...
def visualize_graph_from_data(cluster_data: Dict, output_base_path: str):
    ...
    Accepts the full cluster dictionary and generates the graph.
    """
    if "network_topology" not in cluster_data:
        print("⚠️ Cannot visualize: 'network_topology' missing from cluster data.")
        return
