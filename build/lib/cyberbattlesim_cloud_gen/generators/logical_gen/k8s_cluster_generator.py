...
class K8sClusterGenerator:
    ...
    def __init__(self, config: ClusterDynamicConfig,config_loader_instance:ConfigLoader):
        self.config = config
    ...
    def _select_services_by_strategy(self) -> Set[str]:
        ...
        if strategy == "probability":
            ...
            for service in candidates:
                prob = self.config_loader_instance.get_service_probability(service,self.use_case)
                print(prob)
