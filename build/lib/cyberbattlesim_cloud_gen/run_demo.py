...
from cyberbattlesim_network_gen.generators.logical_gen.k8s_cluster_generator import (
    K8sClusterGenerator,
)
from cyberbattlesim_network_gen.generators.logical_gen.cluster_dynamic_config import (
    ClusterDynamicConfig,
)
from cyberbattlesim_network_gen.generators.network_gen.network_topology_generator import (
...
def main():
    ...
    phys_gen = PhysicalNodeGenerator(cluster_config=cluster_data, num_zones=3, seed=42)
    ...
    cbs_exporter = ClusterAttackGenerator(out_dir=sim_dir, cluster_config=cluster_data)
    ...
    save_yaml(
        generated["identifiers"].to_dict(), OUTPUT_DIR + "/identifiers/identifiers.yaml"
    )
    save_yaml(
        generated["vulnerability_library"],
        OUTPUT_DIR + "/vulnerability_library/vulnerability_library.yaml",
    )
