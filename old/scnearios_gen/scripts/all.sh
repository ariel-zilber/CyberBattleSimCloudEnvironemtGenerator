...
python k8s_cluster_generator_enhanced.py   --config /home/ariel/Documents/thesis/CyberBattleSimExperimentsConfigs/cloud_generators/example.yaml --cve-json final.json   --vuln-db vulnerability_db.yml   -o out6/cluster.json;
